...
public class SaveTeacherFrame2 extends JFrame {
	...
	public SaveTeacherFrame2() {
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (teaNum == null || "".equals(teaNum.trim())) {
					...
					lblMsg.setText("老师编号不能为空!");
					return;
				}
				if (teaNum.length() > 8) {
					lblMsg.setForeground(Color.RED);
					lblMsg.setText("老师编号不能大于8位!");
					return;
				}				
		...
		public static void main(String[] args) {
			SaveTeacherFrame2 saveTeacherFrame = new SaveTeacherFrame2();
			saveTeacherFrame.setVisible(true);
		}
}
