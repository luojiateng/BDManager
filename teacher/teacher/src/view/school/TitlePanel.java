...
public class TitlePanel extends JPanel {
    public TitlePanel() {
        ...
        insertText.setText(new TitleDaoImpl().getNextIndex() + "");
        ...
        insertComit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Title title = new Title(0, text);
                int insert1 = new TitleDaoImpl().insertTitle(title);
                if (insert1 > 0) {
        ...
        deleComit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    int i = new TitleDaoImpl().deleteTitle(s);
                    if (i > 0) {
        ...
        upComit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    int i = new TitleDaoImpl().updataTitle(oldname, newDepNameText);
                    if (i > 0) {
