...
import peopleManager.dao.TitleDao;
import peopleManager.dao.TitleDao;
import peopleManager.dao.TitleDao;
...
public class TitleManager extends JFrame {
    public TitleManager() {
        setTitle("职称管理");
        setSize(700, 300);
        setLocation(624, 325);
        ...
        insertComit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (text.equals("") || text == null) {
                    JOptionPane.showMessageDialog(null, "职称不能为空", "错误", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }
                int insert1 = new TitleDao().insert(text);
                if (insert1 > 0) {
                    JOptionPane.showMessageDialog(null, "添加职称成功");
                }
            }
        });
        ...
        deleComit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    int i = new TitleDao().delete(s);
                    if (i > 0) {
                        JOptionPane.showMessageDialog(null, "删除职称成功");
                    }
        ...
        upComit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    int i = new TitleDao().updata(oldname, newDepNameText);
                    if (i > 0) {
                        JOptionPane.showMessageDialog(null, "修改职称成功");
                    }
