...
import peopleManager.dao.PositionDao;
...
public class PositionManager extends JFrame {
    public PositionManager() {
        ...
        insertText.setText(new PositionDao().getIndex() + "");
        ...
        insertComit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int insert1 = new PositionDao().insert(DepName.getText());
                if (insert1 > 0) {
        ...
        deleComit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    int i = new PositionDao().delete(s);
                    if (i > 0) {
        ...
        upComit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    int i = new PositionDao().updata(oldname, newDepNameText);
                    if (i > 0) {
